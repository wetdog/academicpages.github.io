...
construirlos. Las aplicaciones de estos sistemas los vemos a diario en Amazon, Netflix, Spotify y muchas otras plataformas
...
En la tarde elegí quedarme en 3 conferencias que abordaban diferentes temas de visión por computador, queria conocer algunas
técnicas usadas en este campo para extrapolarlas al dominio del sonido que es donde actualmente trabajo. Inicialmente Jorge Martinez explico la diferencia entre un enfoque de detección basado en modelos preentrenados y un enfoque de rastreador con 
one shot learning, para posteriormente mostrar aplicaciones en videos que combinaban las dos técnicas. Me llamó mucho la atención la frase con la que abrio su presentación de Minsky: " No computer has ever been designed that is ever aware of what it's doing; but most of the time, we aren't either."


Para Finalizar el día Naomi Ceder dio su keynote
